        ...
        <div class="flex w-7/12 flex-grow items-center">
            <div class="mx-auto flex w-10/12 items-center space-x-4">
                ...
                <div class="relative">
                    ...
                    <a href="/cart" class="hidden lg:flex items-center rounded-full outline-none disabled:pointer-events-none bg-white border border-transparent text-gray-600 hover:bg-gray-100 p-3 transition duration-300">
                        <!-- Ikon keranjang -->
